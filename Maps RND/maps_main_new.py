...
def places():
    if request.method == 'POST':
        ...
        place_type = ['mosque','school', 'road', 'river', 'hospital'] #, 'school', 'road', 'river'
        ...
        print("first_end_time", first_end_time-start_time)
        
        locations = []
        for i, s in places_.items():
            # print("----------",s['locationName'])
            lat_lng = extract_lat_lng(s['locationName']+", Bangladesh")
